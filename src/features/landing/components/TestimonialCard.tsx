...
const TestimonialCard = () => (
  <div className="mt-8 card-with-gradient-border rounded-xl shadow-md container mx-auto p-6 relative">
    <FormatQuoteIcon
      className="absolute top-4 left-4 text-[#870e08] rotate-180 scale-x-[1]"
      fontSize="large"
    />
    ...
    <FormatQuoteIcon className="absolute bottom-4 right-4 text-[#870e08]" fontSize="large" />
  </div>
);

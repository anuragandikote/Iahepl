...
const socialLinks = [
  {
    href: "https://www.instagram.com/impact_academy_hyd?utm_source=qr",
    label: "Instagram",
    iconPath:
  ...
  {
    href: "https://www.youtube.com/@impactacademyofhumanexcellence",
    label: "YouTube",
    iconPath:
  ...
  {
    href: "https://www.facebook.com/impactacademysuccess/",
    label: "Facebook",
    iconPath:
